...
public class Navigation {
    ...
    public static void main(String[] args) {
        ...
        String []split = new String[queries];
        ...
        if (!destination.contains(split[0]) && !destination.contains(split[1])){
            System.out.println("There is no train from "+ split[0] + " to " + split[1]);
        }
