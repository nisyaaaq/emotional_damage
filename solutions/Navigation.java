...
public class Navigation {
    ...
    public static void main(String[] args) {
        ...
        String[] src = new String[queries]; //Create String for the startingpoint
        String[] dst = new String[queries];//Create String for desination
        ...
        /*for(int k=0; k<qpath.length; k++){
            String[] station = qpath[k].split(" -> ");
            graph1.addVertex(station[0]);
            graph1.addVertex(station[1]);
        }*/
        ...
        if () { //If there is no starting point
